...
{
	if ( window.FormData && (options.dataType && options.dataType == "binary" || options.data && (window.ArrayBuffer && options.data
...
(function (w, $)
{
	...
	var TE                = {
		name           : GM_info[ "script" ][ "name" ], version : GM_info[ "script" ][ "version" ], status : {},
	...
	TE.config = {
		debug : true, verboseDebug : true, pfRange : 1, preload : true
	};
					...
					success          : $.proxy( function (data, textStatus, request)
					{
						...
						else
						{
							...
							if ( responseHeader[ "Content-Type" ] == "images/jpeg" )
							{
								...
								TE.vbLog( "gname", "TE.load", "Conversions completed.", "Image downloaded in: " + dlTime
																						+ "ms.", "Total time spent on conversion: " + runTime
																								 + "ms." );
	...
	TE.ui.css.master = ` .te_mainColor { color:#22a7f0; }
	...
	TE.ui.css.browsingTweaks.master = `.te_browsetweak_infobutton,.te_browsetweak_readbutton {
	...
	TE.ui.css.browsingTweaks.moreBooks
		= "@media(min-width:768px) { .overlay-title { font-size:.8em; } .col-sm-4 { width: 25% } } @media(min-width:992px) { .col-md-3 { width: 20% } }";

	// Record Keeper CSS.
	TE.ui.css.recordKeeper = ` .te_recordKeeper_finished:hover { border: 3px solid rgba(0,125,0,.8) !important; }
	...
	TE.enhancePage = function ()
	{
		...
		$( document ).ready( function ()
		{
			...
			if ( !TE.on.forum )
			{
				...
				$( "#te_navbarMain" ).append( "<li><a href='javascript:;' style='color:" + TE.ui.mainColor
											  + " !important;' id='te_configNavLink'>ENHANCED</a></li>" );
	...
	(function ()
	{
		...
		//TE.Enhancement.option.main(type,name,description,defaultValue,arguments)
		var opt1 = {
			type : "enable", name : false, description : false, defaultValue : false, arguments : false
		};
	...
	(function ()
	{
					...
					$.when( TE.status.enhancePage ).done( $.proxy( function ()
					{
						...
						if ( typeof TE.User.recordKeeper.data[ TE.book.id ] === "object" )
						{
							if ( TE.User.recordKeeper.data[ TE.book.id ][ "lastSeen" ] > 1 )
							{
								...
								$( "#te_readOnlineButton" ).before( "<a id='te_resumeButton' class='book-read-button button-stack' href='" + resumeUrl
																	+ "'></a>" );
		...
		var opt2 = {
			type         : "toggle", name : "Show Messages", description : "Displays loading messages while preparing images for display.",
			defaultValue : true, arguments : false
		};
		options.push( new TE.Enhancement.option.main( opt1.type, opt1.name, opt1.description, opt1.defaultValue, opt1.arguments ) );
		...
		main         = {
			init             : function ()
			{
				...
				$.when( TE.status.enhancePage ).then( $.proxy( function ()
				{
					...
					{
						$( "#te_browseTagsLite_tabs" ).append( `<a id="te_btl_btn_` + alphabet[ i ]
															   + `" class="item te_btl_tabButton" data-tab="te_btl_tab_` + alphabet[ i ] + `">`
															   + alphabet[ i ] + `</a>` );
						$( "#te_btl_mainDisplay" ).append( `
							<div id="te_btl_tab_` + alphabet[ i ]
														   + `" class="ui bottom attached inverted tab segment" 							data-tab="te_btl_tab_`
														   + alphabet[ i ] + `">
							</div>
							` );
					}
					$( "#te_browseTagsLite_tabs" ).append( `<a id="te_btl_btn_reload" class="icon item"><i class="icon refresh" style="color:`
														   + TE.ui.mainColor + `"></i></a>` );
	...
	(function ()
	{
		...
		//TE.Enhancement.option.main(type,name,description,defaultValue,arguments)
		var opt1 = {
			type      : "toggle", name : "Remove Sidebar", description : "Removes the &quot;random picks&quot; sidebar.", defaultValue : false,
			arguments : false
		};
		var opt2 = {
			type : "toggle", name : "More Books", description : "Displays one extra book per row.", defaultValue : false, arguments : false
		};
		var opt3 = {
			type         : "toggle", name : "Thumbnail Links", description : "Clicking anywhere on the thumbnail image will load the Doujin.",
			defaultValue : false, arguments : false
		};
		var opt4 = {
			type         : "toggle", name : "Skip Info", description : "Skips the book info page and takes you directly to the reader.",
			defaultValue : false, arguments : false
		};
	...
	(function ()
	{
		 ...
		 *******************************************************/
		var name = "Infinity Scrolling", shortName = TE.fn.camelize( name ), description = "Scroll down to load images.", options = [], section = "Reader", incompatible = [ "Seamless Viewing" ], main = {};
	...
	TE.settings = {
		render    : function ()
		{
			...
			$( "#te_config_modal" ).prepend( '<div class="header"><h1><span class="te_mainColor">Tsumino Enhanced</span> <span id="te_version" class="small">'
											 + TE.version + '</span></h1></div>' );
			if ( !TE.User.tsuminoEnhanced.upToDate )
			{
				...
				$( "#te_version" ).after( '&nbsp;&nbsp;<div id="te_updateButton" class="ui big labeled button" tabindex="0"><div class="ui red button"><i class="upload icon"></i>Update!</div><a class="ui basic red left pointing label">'
				...
				{
					$( "body" ).append( '<div id="te_refresh_modal" class="ui basic modal"><i class="remove icon"></i><div class="header" style="font-size: 3em;"><i class="upload icon"></i> Updating Tsumino Enhanced...</div><div class="image content"><div class="image"><i class="refresh icon"></i></div><div class="description" style="font-size: 1.5em;"><p>You will be prompted to install the update in just a moment.</p><p>In order for the update to take effect, you must refresh this page after it has finished installing.</p><p>Do you wish to refresh the page now?</p></div></div><div class="actions"><button id="te_refreshPageButton" class="massive fluid green ui button">Refresh</button></div></div>' );
...
<div class="ui centered grid">
			...
			<div class="content">
				...
				<div class="description">
					<table class="ui single line definition blue left aligned table">
						...
						<tr>
							<td>Changelog</td>
							<td><button id="te_tobyLinks_teChangelog" data-content="Go to the TE Updates section of my blog." class="ui large circular inverted blue icon button teTooltip"><i class="external icon"></i></button></td>
						</tr>
	...
	<div class="five wide column">
		<div class="ui fluid purple card">
			<div class="image">
				<img src="data:image/jpeg;base64,"/>
			</div>
			<div class="content">
							...
							for (var oKey in obj[ "options" ])
							{
								if ( obj[ "options" ].hasOwnProperty( oKey ) )
								{
									...
									if ( option[ "type" ] == "enable" )
									{
										...
										$( "#" + obj[ "shortName" ] + "_group" ).prepend( `<div class="ui middle aligned toggle checkbox">
	...
	TE.init = function ()
	{
		...
		TE.log( "gname", TE.name, "Version:	" + TE.version, "Latest:		" + TE.User.tsuminoEnhanced.latestVersion, "Debugging:	"
																														  + debugState, "Enhancements:", eeLongNames );
